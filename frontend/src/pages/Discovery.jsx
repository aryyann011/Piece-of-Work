  ...
  return (
    <div style={{ 
      ...
      <div className="dashboard-card" style={{ 
          ...
          // FIX 1: Increased minHeight to fit the card comfortably
          minHeight: isMobile ? "700px" : "0", 
          marginBottom: isMobile ? "20px" : "0",
          paddingTop: "30px",
          // FIX 2: Added bottom padding so the scroll doesn't stop exactly at the card edge
          paddingBottom: isMobile ? "50px" : "0" 
      }}>
        
        {/* HEADER & SEARCH */}
        <div style={{ zIndex: 10, width: "100%", padding: "0 30px", marginBottom: "10px" }}>
          {/* <h2 style={{ margin: "0 0 15px 0", fontSize: "24px", color: "white" }}>The Stack & Discover</h2> */}
        ...
        {/* THE CARD STACK */}
        <div style={{ 
            // FIX 3: transformOrigin "top center" ensures it scales from the top, 
            // preventing the bottom from getting pushed off-screen.
