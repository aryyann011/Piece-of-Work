  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto text-white min-h-screen pb-20">
      ...
      <div className="relative mb-20 md:mb-24">
        ...
        <div className="absolute -bottom-12 md:-bottom-16 left-1/2 -translate-x-1/2 flex flex-col items-center z-10">
          ...
          <div className="mt-3 md:mt-4 text-center">
            <h1 className="text-2xl md:text-4xl font-black tracking-tight mt-2 drop-shadow-lg px-2">{displayProfile.name || "Unnamed Student"}</h1>
            <p className="text-blue-400 font-bold tracking-widest uppercase text-xs md:text-sm drop-shadow-sm">{displayProfile.regNo || "ID: N/A"}</p>
          </div>
        </div>
      </div>
